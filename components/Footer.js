    ...
    return (
        <footer className="footer">
            <div className="container">
                ...
                <div className="last_footer_item">
                    <button type="button">Request Invite</button>
                    <p>© Easybank. All Rigth Reserved</p>
                </div>
            </div>
        </footer>
    )
